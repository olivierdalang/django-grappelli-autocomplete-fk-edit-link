            ...
            $('.grp-autocomplete-wrapper-fk').each(function () {
                ...
                var updateLink = function () {
                    ...
                    if (objectID) {
                        ...
                        editLink = $('<a target="_blank" style="position:relative;top:5px;margin-left:20px;white-space:nowrap;font-weight:bold;" onclick="window.open(\'' + editURL + '?_popup=1\',\'\',\'width=1000,height=500\'); return false;" href="' + editURL + '?_popup=1">Edit</a>');
